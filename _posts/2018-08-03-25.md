...
1. [NLP를 위한 CNN(1): Understanding CNN for NLP](https://reniew.github.io/25/) [현재글]
2. [NLP를 위한 CNN(2): Convolutional Neural Network for Sentence Classification](https://reniew.github.io/26/)
